	...
	function()
	{
		...
		for(var a=0;a<this.pc;a++)
		{
			this.petals.push(new Petal
								(Garden.random
									(Garden.options.petalStretch.min,Garden.options.petalStretch.max),
...
Garden.prototype=
{
	...
	function(a)
	{
		...
		for(var c=0;c<this.blooms.length;c++)
		{
			...
			if(d===a)
			{
				this.blooms.splice(c,1);return this
			}
		}
	},
	createRandomBloom:
	function(a,b)
	{
		this.createBloom(a,b,Garden.randomInt
							(Garden.options.bloomRadius.min,Garden.options.bloomRadius.max),
							 Garden.randomrgba
...
Garden.random=
	function(b,a)
	{
		...
		Garden.circle=2*Math.PI;Garden.degrad=
			function(a)
						{
